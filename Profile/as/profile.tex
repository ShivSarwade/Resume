...
\begin{minipage}[t]{0.25\textwidth}
    \vspace{-10pt}
    \raggedleft
    \includegraphics[width=3cm]{./as.jpeg}
\end{minipage}
...
Kotlin, Flutter, JWT Authentication, RBAC, Redux Toolkit, React Router, Vite
...
\section*{Education}
\textbf{Masters in Computer Application (MCA)}  \hfill 2025 -- 2027 \quad \textbf{CGPA: 8.83} \textbf{(80.96\%)}

\vspace{4pt} 

\textbf{Bachelor in Business Administration in Computer Application (BBA-CA)}  \hfill 2022 -- 2025 \quad \textbf{CGPA: 9.17} \textbf{(85.04\%)}
